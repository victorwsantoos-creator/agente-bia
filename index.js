...
import { initWebSocket, trackMessage, trackEscalation, trackLeadQualified, getAllConversations } from './realtime.js';
...
app.post('/webhook', async (req, res) => {
  ...
  } catch (err) { console.error('Erro no webhook:', err); res.status(500).json({ error: 'Erro interno' }); }
});
